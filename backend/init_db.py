...
DEFAULT_GENERATOR_TYPES = [
  ...
  {"이름": "에카-프랑슘 폭발 에너지 발전기", "세부설명": "가상의 초중금속 에카-프랑슘이 일으키는 순간적 핵붕괴 폭발을 안정적으로 포획해 초고출력 전력을 생성하는 발전기입니다.", "설치비용(수)": 543000, "설치비용(높이)": 175, "설치시간(초)": 830, "생산량(에너지수)": 764000, "생산량(에너지높이)": 46, "크기": 5.8, "내열한계": 33000, "발열": 24700},
