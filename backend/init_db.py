...
DEFAULT_GENERATOR_TYPES = const rawGenerators = [
  ...
  {"이름": "인공 태양 발전기", "세부설명": "핵융합 기반의 초고출력 에너지를 생산합니다.", "설치비용(수)": 200000, "설치비용(높이)": 22, "설치시간(초)": 213, "생산량(에너지수)": 250000, "생산량(에너지높이)": 10, "크기": 5, "내열한계": 6500, "발열": 1200},
  {"이름": "초신성 발전기", "세부설명": "초신성 폭발 에너지를 이용한 가상의 초고출력 발전 장치입니다.", "설치비용(수)": 927000, "설치비용(높이)": 25, "설치시간(초)": 234, "생산량(에너지수)": 500000, "생산량(에너지높이)": 11, "크기": 6.5, "내열한계": 10000, "발열": 6000},
  {"이름": "반물질 발전기", "세부설명": "반물질과 물질의 반응으로 극대한 에너지를 생산합니다.", "설치비용(수)": 100000, "설치비용(높이)": 1000000, "설치시간(초)": 256, "생산량(에너지수)": 100000, "생산량(에너지높이)": 14, "크기": 8, "내열한계": 35000, "발열": 50000}
]
