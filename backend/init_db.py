...
DEFAULT_GENERATOR_TYPES = [
  ...
  {"이름": "신성 엔진 발전기", "세부설명": "현실 법칙을 초월한 에너지 원천을 직접 조율해 사실상 무한에 가까운 힘을 발산하는 최종 단계의 초월적 발전기입니다.", "설치비용(수)": 100000, "설치비용(높이)": 1234000, "설치시간(초)": 465, "생산량(에너지수)": 100000, "생산량(에너지높이)": 25, "크기": 5.5, "내열한계": 19100, "발열": 9250},
]
