...
class User(Base):
    ...
    electronic_sparkle_data = Column(BigInteger, default=0, nullable=False)
    electronic_sparkle_high = Column(BigInteger, default=0, nullable=False)
    ...
    rebirth_chain_upgrade = Column(Integer, default=0, server_default="0", nullable=False)
    upgrade_batch_upgrade = Column(Integer, default=0, server_default="0", nullable=False)
    rebirth_start_money_upgrade = Column(Integer, default=0, server_default="0", nullable=False)
    sparkle_chance_upgrade = Column(Integer, default=0, server_default="0", nullable=False)
    sparkle_amount_upgrade = Column(Integer, default=0, server_default="0", nullable=False)
