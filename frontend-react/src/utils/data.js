...
const rawGenerators = [
  ...
  {"이름": "인공 태양 발전기", "세부설명": "핵융합 기반의 초고출력 에너지를 생산합니다.", "설치비용(수)": 200000, "설치비용(높이)": 22, "설치시간(초)": 213, "생산량(에너지수)": 250000, "생산량(에너지높이)": 10, "크기": 4.3, "내열한계": 6500, "발열": 1200},
  {"이름": "항성 핵 발전기", "세부설명": "작은 항성의 핵 반응을 모사해 고밀도 에너지를 안정적으로 뽑아내는 초고출력 발전기입니다.", "설치비용(수)": 927000, "설치비용(높이)": 25, "설치시간(초)": 234, "생산량(에너지수)": 500000, "생산량(에너지높이)": 11, "크기": 4.5, "내열한계": 10000, "발열": 6000},
  {"이름": "초신성 발전기", "세부설명": "초신성 폭발 에너지를 이용한 가상의 초고출력 발전 장치입니다.", "설치비용(수)": 325000, "설치비용(높이)": 27, "설치시간(초)": 256, "생산량(에너지수)": 420000, "생산량(에너지높이)": 12, "크기": 4.7, "내열한계": 13500, "발열": 8500},
  {"이름": "반물질 발전기", "세부설명": "반물질과 물질의 반응으로 극대한 에너지를 생산합니다.", "설치비용(수)": 175000, "설치비용(높이)": 29, "설치시간(초)": 279, "생산량(에너지수)": 267000, "생산량(에너지높이)": 13, "크기": 4.8, "내열한계": 18500, "발열": 12500},
  {"이름": "양자 진동 발전기", "세부설명": "양자장의 미세한 에너지 흔들림을 포착해 안정적으로 전력으로 변환하는 초고효율 미래형 발전기입니다.", "설치비용(수)": 115000, "설치비용(높이)": 31, "설치시간(초)": 303, "생산량(에너지수)": 105000, "생산량(에너지높이)": 15, "크기": 4.9, "내열한계": 35000, "발열": 50000},
  {"이름": "쿼크 응축 발전기", "세부설명": "쿼크-글루온 플라즈마를 초고압으로 안정화해 압도적인 에너지를 추출하는 초고밀도 발전기입니다.", "설치비용(수)": 870000, "설치비용(높이)": 36, "설치시간(초)": 328, "생산량(에너지수)": 472500, "생산량(에너지높이)": 17, "크기": 5.0, "내열한계": 42000, "발열": 70000},
  {"이름": "양자 진동 발전기", "세부설명": "인공적으로 형성한 미세 블랙홀의 강력한 중력 에너지를 끌어내 전력으로 전환하는 초중력 기반 발전기입니다.", "설치비용(수)": 100000, "설치비용(높이)": 1000000, "설치시간(초)": 354, "생산량(에너지수)": 100000, "생산량(에너지높이)": 18, "크기": 5.2, "내열한계": 55000, "발열": 100000},
];
